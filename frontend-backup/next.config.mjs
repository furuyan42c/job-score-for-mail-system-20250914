...
const nextConfig = {
  // Enable React strict mode - temporarily disabled due to onClick handler serialization error
  ...
  experimental: {
    ...
    // Optimize CSS - disabled due to missing postcss-purgecss dependency
    optimizeCss: false,
  },
  ...
  async headers() {
    return [
      ...
      {
        source: '/:path*.(css|js|png|jpg|jpeg|gif|ico|svg|woff|woff2)',
        headers: [
          {
            key: 'Cache-Control',
