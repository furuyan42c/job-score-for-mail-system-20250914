        ...
        - tablist [ref=e160]:
          ...
          - tab "リアルタイム" [ref=e164]:
            - generic [ref=e165]:
              - img [ref=e166]
              - text: リアルタイム
        - tabpanel "SQLクエリ" [ref=e169]:
          - generic [ref=e170]:
            - generic [ref=e171]:
              - img [ref=e172]
              - generic [ref=e175]: クエリエディタ
              - generic [ref=e176]: "テーブル: users"
            - textbox "SQL Query Editor - SELECT * FROM users WHERE is_active = true;" [ref=e177]: SELECT * FROM users LIMIT 10;
            - generic [ref=e178]:
              - button "クエリ実行" [ref=e179]:
                - img
                - text: クエリ実行
              - button "実行計画" [ref=e180]:
                - img
                - text: 実行計画
              - generic [ref=e181]: Ctrl+Enter で実行
            - generic [ref=e182]: "\"failed to parse select parameter (count(*))\" (line 1, column 6)"
          - generic [ref=e183]:
            - heading "クエリ結果" [level=3] [ref=e185]
            - generic [ref=e187]:
              - img [ref=e188]
              - paragraph [ref=e192]: SQL execution 実装予定 (T069 not implemented yet)
  - alert [ref=e193]
```