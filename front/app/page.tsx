...
export default function DatabaseAdmin() {
  ...
  const executeQuery = () => {
    ...
    setTimeout(() => {
      ...
      setQueryResult(sampleTableData[tableName as keyof typeof sampleTableData] || [])
            ...
            <TabsContent value="query" className="flex-1 flex flex-col m-0">
              <div className="p-4 border-b border-border bg-muted/30">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium">SQLクエリエディタ</span>
              ...
              <div className="flex-1 p-4">
                ...
                {queryResult.length > 0 ? (
                  ...
                  <div className="border border-dashed border-border rounded-lg p-8 text-center">
                    ...
                    <p className="text-muted-foreground">クエリを実行して結果を表示</p>
                  </div>
                )}
              </div>
            </TabsContent>
